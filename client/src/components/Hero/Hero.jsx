    ...
    return (
            <div className="p-16 flex justify-around items-center gap-4 bg-[#f6f0d8] mxs:p-4 mxs:flex-col msm:flex-col msm:p-4 mmd:p-8 mmd:flex-col">
                ...
                <div className="grid grid-cols-2 gap-3 mxs:grid-cols-1 msm:grid-cols-1 msm:place-items-center">
                    <img loading="lazy" src={Hero1} alt="" className="w-[370px] h-[240px] object-cover rounded-lg shadow-[0_5px_15px_rgba(0, 0, 0, 0.35)] hover:scale-105 duration-200 ease-in cursor-pointer hover:shadow-2xl"/>
                    <img loading="lazy" src={Hero2} alt="" className="w-[370px] h-[240px] rounded-lg shadow hover:shadow-2xl hover:scale-105 duration-200 ease-in cursor-pointer"/>
                    <img loading="lazy" src={Hero3} alt="Photo by Rene Terp: https://www.pexels.com/photo/two-women-holding-candles-1405528/" className="w-[370px] h-[240px] rounded-lg shadow object-cover hover:shadow-2xl hover:scale-105 duration-200 ease-in cursor-pointer"/>
                    <img loading="lazy" src={Hero4} alt="Photo by Ana Villacorta: https://www.pexels.com/photo/birthday-cake-in-close-up-shot-14849495/" className="w-[370px] h-[240px] rounded-lg object-cover shadow hover:shadow-2xl hover:scale-105 duration-200 ease-in cursor-pointer"/>
                </div>
            </div>
    );
};
